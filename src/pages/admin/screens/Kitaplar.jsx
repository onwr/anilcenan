...
const BooksComponent = () => {
  ...
  const handleAddBook = async () => {
    if (!newBook.title || !newBook.author || !newBook.kategori) return;
              ...
              >
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="bg-blue-400 px-5 py-1 rounded-lg text-white"
                  >
                    Detaylar
                  </button>
                  <button
                    onClick={() => handleDeleteBook(book.id)}
                    className="bg-red-400 px-5 py-1 rounded-lg text-white"
                  >
                    Sil
                  </button>
                </div>
