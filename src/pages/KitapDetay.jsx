  ...
  return (
    <div>
      ...
      <div className="mx-auto bg-black/80 py-8">
        <div className="flex md:flex-row flex-col-reverse container max-w-screen-xl justify-between items-center mx-auto gap-5">
          <div className="w-full text-center md:text-left">
            <p className="text-5xl text-white">{kitap.title}</p>
            <p className="text-gray-100 my-2">{kitap.author}</p>
          ...
          <div className="w-1/2">
            <img
              src={kitap.imageUrl}
              alt="Kitap Resmi"
              className="w-auto ml-auto h-[250px]"
            />
          </div>
        </div>
